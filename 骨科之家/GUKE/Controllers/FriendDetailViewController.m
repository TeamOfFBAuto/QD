...
- (void)creatUI
{
    ...
    [telBtn setImage:[UIImage imageNamed:@"friend_phone_ico"] forState:UIControlStateNormal];
    ...
    msgBtn1.frame = CGRectMake(280, 5, 30, 30);
...
{
    UIImageView *imgView = (UIImageView *)[[[self.view viewWithTag:BGVIEW_TAG] viewWithTag:FIRST_BG_VIEW] viewWithTag:UIIMAGEVIEW_TAG];
    [imgView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@%@",IMAGE_BASE_URL,userModel.icon]] placeholderImage:[[UIImage alloc] initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"portrait_ico@2x" ofType:@"png"]]];
